...
const Header = () => {
  return (
      <Popover className={"sticky z-50 mx-auto flex items-center sm:px-12 px-6 py-2 h-24"}>
        ...
        <Link href="contact"><button type="button" className="text-white rounded-full py-2 px-5 leading-6 bg-[#6C6CFF]">Get Started <FontAwesomeIcon icon={faArrowRight} className="h-4 w-4"/></button></Link>
        </div>
      </Popover>
  );
};
